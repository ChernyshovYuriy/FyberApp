...
public class RequestParametersDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        final View layout = inflater.inflate(R.layout.request_parameters_dialog_layout,
                getActivity().findViewById(R.id.item_root));

        final EditText uidEditView = layout.findViewById(R.id.uid_edit_view);
        final EditText apiKeyEditView = layout.findViewById(R.id.api_key_edit_view);
        final EditText appIdEditView = layout.findViewById(R.id.app_edit_view);
        final EditText pub0EditView = layout.findViewById(R.id.pub0_edit_view);
        final CheckBox useFakeResponseCheckView
                = layout.findViewById(R.id.use_fake_data_check_view);
        ...
        builder.setTitle(R.string.request_parameters_dialog_title)
                ...
                .setPositiveButton(
                        R.string.ok_string,
                        (dialog, id) -> ((MainActivity) getActivity()).onRequestParametersDialogResult(
